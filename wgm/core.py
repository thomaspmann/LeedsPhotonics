...
class WGM:
    ...
    def e_prime(self, k, zeta):
        ...
        if k == 4:
            ...
            return -269500*m**(-8) * (-232 + 160*m**2 + 543*m**4 - 447*m**6 - 186*m**8 + 165*m**10 - 15*m**12 + 4*m**14)
        elif k == 8:
            a = -10 * (-459200 + 286000*m**2 + 1360312*m**4 - 1305476*m**6 - 433952*m**8 + 717562*m**10 - 209039*m**12
                       -21542*m**14 + 7060*m**16)
            b = 3 * (33600 - 441600*m**2 - 626496*m**4 + 891008*m**6 + 306416*m**8 - 505696*m**10 - 72488*m**12
    ...
    def d(self, k, zeta):
        ...
        if k == 0:
            ...
            num = zeta * (40*(-1 +3*m**2 - 3*m**4 + 351*m**6) - 479*(m**2-1)**3 * zeta**3 - self.e(5, zeta))
            den = 2**(4/3) * 6300 * m
            return num / den
        elif k == 6:
            num = 5*m**2*(-13 -16*m**2 + 4*m**4) + 2*m**2*(128 - 4*m**2 + m**4)*zeta**3 - self.e(6, zeta)
            return num / 1400
        elif k == 7:
